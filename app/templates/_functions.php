...
function _s_scripts() {
  ...
  wp_enqueue_script( '_s-scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array( 'jquery' ), '<%= themeversion %>' );
...
function _s_ie_scripts() { ?>
	...
	<![endif]-->
<?php }
add_action( 'wp_head', '_s_ie_scripts', 8 );
...
add_action('wp_footer', '_s_js_init', 50);
...
/**
 * Load shortcodes for Foundation.
 */
require get_template_directory() . '/inc/shortcodes.php';

/**
 * Load walkers for topbar navigation
 */
